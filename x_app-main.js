...
app.get('/x_dashboard.html', (_req, res) => res.sendFile(path.join(__dirname, 'dashboard1.html')));
app.get('/x_Dashboard.html', (_req, res) => res.sendFile(path.join(__dirname, 'dashboard1.html')));
app.get('/dashboard1.html', (_req, res) => res.sendFile(path.join(__dirname, 'dashboard1.html')));
app.get('/x_server-main.html', (_req, res) => res.sendFile(path.join(__dirname, 'x_server-main.html')));
app.get('/x_server.html', (_req, res) => res.sendFile(path.join(__dirname, 'x_server.html')));
